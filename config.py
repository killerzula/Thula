...
PLAYER_A_TARGET_CENTERED_Y = 280 + (PLAYING_CARD_CENTERED_HEIGHT // 2)

PLAYER_B_TARGET_CENTERED_X = 300 + (PLAYING_CARD_CENTERED_WIDTH // 2)
PLAYER_B_TARGET_CENTERED_Y = 200 + (PLAYING_CARD_CENTERED_HEIGHT // 2)

PLAYER_C_TARGET_CENTERED_X = 500 + (PLAYING_CARD_CENTERED_WIDTH // 2)
PLAYER_C_TARGET_CENTERED_Y = 110 + (PLAYING_CARD_CENTERED_HEIGHT // 2)

PLAYER_D_TARGET_CENTERED_X = 780 + (PLAYING_CARD_CENTERED_WIDTH // 2)
PLAYER_D_TARGET_CENTERED_Y = 200 + (PLAYING_CARD_CENTERED_HEIGHT // 2)
